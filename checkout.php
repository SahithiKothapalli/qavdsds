    ...
    <div style="margin: 2%;" class="chrow">
                ...
                <form action="" method="POST">
                    <div class="chrow">
                        <div class="col-50">
                            ...
                            <input type="text" id="email" name="email" placeholder="johndoe@example.com" required>
                            <label for="adr"><i class="fa fa-address-card-o"></i> Address</label>
                            <input type="text" id="adr" name="address" placeholder="Road no:12, High Tech City" required>
                            <label for="city"><i class="fa fa-institution"></i> City</label>
                            <input type="text" id="city" name="city" placeholder="Hyderabad" required>
                            <div class="chrow">
                                <div class="col-50">
                                    <label for="state">State</label>
                                    <input type="text" id="state" name="state" placeholder="Telangana" required>
                                </div>
                                <div class="col-50">
                                    <label for="zip">Zip</label>
                                    <input type="text" id="zip" name="zip" placeholder="550325" required>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-25">
            ...
            <h4>Cart <span class="checkprice" style="color:black"><i class="fa fa-shopping-cart"></i> <b></b></span></h4>                        
                            ...
                            if($cust_id != 0)
                            {
                                            ...
                                            if ($result->num_rows > 0) {
                                                    while($row = $result->fetch_assoc()) {
                                                        ...
                                                        $t_price += $p_price;
                                                       echo '<p><a href="product.php?'. $row["pro_id"] .'">'. $row["pro_name"] .'</a> <span class="checkprice">INR '. $p_price .'</span></p>';
                                                    }
                                            }
                            }
                ?>
                ...
                <hr>
                <p>Total <span class="price" style="color:black"><b>INR <?php echo $t_price; ?></b></span></p>
            </div>
        </div>
    </div>
